...
@app.route("/")
#Route - what you type into browser to go to diff pages, abt pages, home, route decorators
#add additional functionality to existing funcations
@app.route("/home")
def home():
